...
import com.chenshinan.designpattern.C16Interpreter.interpreter.ElementExpression;
import com.chenshinan.designpattern.C16Interpreter.interpreter.ElementTerminalExpression;
import com.chenshinan.designpattern.C16Interpreter.interpreter.PropertyTerminalExpression;
import com.chenshinan.designpattern.C16Interpreter.interpreter.ReadXmlExpression;

import java.util.*;

/**
 * 解析器：根据语法来解析表达式，转换成为相应的抽象语法树
 */
public class Parser {
    /**
